                ...
                @foreach ($sliders as $slide)
                    <div class="item-slide">
                        ...
                        <div class="slide-info slide-1">
                            ...
                            <span class="subtitle">{{$slide->suptitle}}</span>
                            <p class="sale-info">Only price: <span class="price">{{$slide->price}} Kip</span></p>
            ...
            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                ...
                <div class="product product-style-2 equal-elem ">
                    ...
                    <div class="product-info">
                        ...
                        <div class="wrap-price"><ins><p class="product-price">{{$sproduct->sale_price}} Kip</p></ins> <del><p class="product-price">{{$sproduct->regular_price}} Kip</p></del></div>
                    </div>
                </div>
                                ...
                                @foreach ($lproducts as $lproduct)
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        <div class="product-info">
                                            ...
                                            <div class="wrap-price"><span class="product-price">{{$lproduct->regular_price}} Kip</span></div>
                                        </div>
                                    </div>
                                @endforeach
                                    ...
                                    @foreach ($c_products as $c_product)    
                                        <div class="product product-style-2 equal-elem ">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="wrap-price"><span class="product-price">{{$c_product->regular_price}} Kip</span></div>
                                            </div>
                                        </div>
                                    @endforeach
